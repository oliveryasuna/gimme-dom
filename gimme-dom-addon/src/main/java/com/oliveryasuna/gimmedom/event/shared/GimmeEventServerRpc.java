...
public interface GimmeEventServerRpc extends ServerRpc {
  ...
  // TODO: void onabort(DomUIEvent event);
  ...
  // TODO: void onbeforeunload(DomUIEvent event);
  ...
  // TODO: void onerror(DomUIEvent event);
  // TODO: void onerror(DomProgressEvent event);
  ...
  // TODO: void onfullscreenerror(DomUIEvent event);
  void onhashchange(DomHashChangeEvent event);
  void oninput(DomEvent event);
  // TODO: void oninput(DomInputEvent event);
  ...
  // TODO: void onload(DomUIEvent event);
  ...
  void onmousewheel(DomWheelEvent event);
  ...
  // TODO: void onunload(DomUIEvent event);
